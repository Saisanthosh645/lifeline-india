...
class User(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column(PGUUID(as_uuid=True), primary_key=True, default=lambda: uuid4())
    ...
    role_id: Mapped[uuid.UUID] = mapped_column(PGUUID(as_uuid=True), default=lambda: uuid4(), nullable=False)
